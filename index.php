...
<html lang="en">
<head>
<title>DrivEzee Bootstrap Responsive Website Template | Home :: w3layouts</title>

<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="DrivEzee Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
		...
		<div class="container">
			<div class="banner_top">
				<div class="logo wow fadeInLeft animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
					<h1><a href="index.html"><span>D</span>rivEzee</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav cl-effect-14">
						...
						<li><a href="contact.html">Covid 19 resources</a></li>
					...
					<ul class="rslides" id="slider3">
						<li>
							...
							<div class="slider-info">
							    <h3>Legacy being driven</h3>
							</div>
						</li>
						<li>
							<div class="slider-info">
							     <h3>Securely serving </h3>
						    </div>
						</li>
						<li>
							
							<div class="slider-info">
							     <h3>Pioneer compasses</h3>
							</div>
						</li>
	...
	<div class="container">
		...
		<div class="bottom-grids agileinfo">
			...
			<div class="col-md-6 bottom-grid grid-one wow fadeInRight animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
				<h4>DrivEzee ignites the opportunity by setting the world on motion.</h4>
				<p>People are elated when they move from one place to another whether be it across the lavish cities or towards their native places. It all started as a way to tap a button to get a ride and has led to thousands of moments of human connections, their interactions physically as people around the globe visit variety of places and we serve as a junction. DrivEzee is committing to become a fully electric and minimal emission platform since 2012 and looking forward to seeing more. Along with it, 100% of rides with safety are being encouraged by us.</p>
...
<!-- Services -->
	<div class="why-choose-agile">
		<div class="container">
			<h3 class="w3l_head">Our Offerings</h3>
			<div class="why-choose-agile-grids-top">
				...
				<div class="col-md-4 agileits-w3layouts-grid img">
					<img src="images/cc6.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-4 agileits-w3layouts-grid">
					<div class="wthree_agile_us">
					<div class="col-xs-3 agile-why-text">
